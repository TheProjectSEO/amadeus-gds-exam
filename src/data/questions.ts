...
const rawQuestions: [number, string, string, string, string][] = [
  ...
  [11, 'encode_decode', 'Encoding & Decoding', 'Display the 10 nearest airports to Paris', 'DAC PAR/N'],
  [12, 'encode_decode', 'Encoding & Decoding', 'Display the 10 nearest airports to London', 'DAC LON/N'],
